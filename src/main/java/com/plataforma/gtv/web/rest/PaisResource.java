...
/**
 * REST controller for managing {@link com.plataforma.gtv.domain.Pais}.
 */
@RestController
...
public class PaisResource {
    ...
    public List<Pais> getAllPais(
        ...
        if ("endereco-is-null".equals(filter)) {
            LOG.debug("REST request to get all Paiss where endereco is null");
            return paisService.findAllWhereEnderecoIsNull();
        }

package com.plataforma.gtv.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.plataforma.gtv.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.plataforma.gtv.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.plataforma.gtv.domain.User.class.getName());
            createCache(cm, com.plataforma.gtv.domain.Authority.class.getName());

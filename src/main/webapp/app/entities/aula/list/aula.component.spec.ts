...
import { sampleWithRequiredData } from '../aula.test-samples';
...
describe('Aula Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.aulas()[0]).toEqual(expect.objectContaining({ id: 31179 }));
  });

  describe('trackId', () => {
    it('Should forward to aulaService', () => {
      const entity = { id: 31179 };
      jest.spyOn(service, 'getAulaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAulaIdentifier).toHaveBeenCalledWith(entity);

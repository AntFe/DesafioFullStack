...
import { AlunoService, RestAluno } from './aluno.service';

const requireRestSample: RestAluno = {
  ...sampleWithRequiredData,
  matriculaData: sampleWithRequiredData.matriculaData?.toJSON(),
};

...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../professor.test-samples';

import { ProfessorService, RestProfessor } from './professor.service';

const requireRestSample: RestProfessor = {
  ...sampleWithRequiredData,
  ingresso: sampleWithRequiredData.ingresso?.toJSON(),
};
